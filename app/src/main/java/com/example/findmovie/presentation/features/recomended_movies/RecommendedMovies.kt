...
import com.example.findmovie.databinding.FragmentRecomendedMoviesBinding
...
import com.example.findmovie.presentation.features.my_list.MyListDirections
...
@AndroidEntryPoint
class RecommendedMovies : BaseFragment<FragmentRecomendedMoviesBinding>(FragmentRecomendedMoviesBinding::inflate) {
    ...
    private val genresAdapter by lazy {
        GenreAdapter { clickedGenre ->
            val genreValue = if (clickedGenre.value == getString(R.string.all)) null else clickedGenre.value
